...
import { LayoutDashboard, Leaf, Trophy, Share2, LogOut, Moon, Sun } from 'lucide-react';
...
const Sidebar = ({ activeTab, setActiveTab }) => {
  ...
  return (
    <div className="w-64 h-screen bg-zinc-50 dark:bg-zinc-950 text-zinc-900 dark:text-zinc-100 transition-colors duration-200 border-r border-zinc-200 dark:border-emerald-500/20 p-6 flex flex-col justify-between shrink-0 font-sans">
      <div>
